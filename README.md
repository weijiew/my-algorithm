...
1. [1480.一维数组的动态和](problem\1480.一维数组的动态和.java) 
   1. 简单遍历即可！
   2. 第 n 次写了，水题！不需要思考！
2. [1512.好数对的数目](problem\1512.好数对的数目.java) 
   1. 暴力很简单。
   2. 第二种解法比较有趣！
3. [867.转置矩阵](problem\867.转置矩阵.java)
   1. 矩阵转置，注意行列关系。
   2. 对于方阵来说原地转置没问题，但是不是方阵的话需要！
4. [283.移动零](problem\283.移动零.java) 将数组中的零移动到末尾。 
5. [1431.拥有最多糖果的孩子](problem\1431.拥有最多糖果的孩子.java) 
   1. 简单题，纸老虎！
6. * [167.两数之和-ii-输入有序数组](problem\167.两数之和-ii-输入有序数组.java)   
   1. 因为数组有序，双指针头尾索引即可。         
   2. 双指针！
## TODO

4. [1470.重新排列数组.java](problem\1470.重新排列数组.java) 
   1. 暴力。
