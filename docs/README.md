...
|      [🎯21. 合并两个有序链表](Leetcode/0021.md)       |    合并两个有序链表，归并排序的思想，注意思考递归写法的实现！    |
|  [🎯83. 删除排序链表中的重复元素](Leetcode/0083.md)   |                     **模拟题**，有序链表去重                     |
| [🎯82. 删除排序链表中的重复元素 II](Leetcode/0082.md) |   **模拟题**，上一题的加强版，不仅仅是去重，而是删除重复元素。   |
|   [🎯19. 删除链表的倒数第N个节点](Leetcode/0019.md)   | **模拟题**，可以直接遍历，也可以用**快慢指针**写，注意特殊情况。 |
|          [🎯206. 反转链表](Leetcode/0206.md)          |    **模拟题**，原地反装链表，迭代和递归，仔细思考递归实现 ！     |
|          [🎯234. 回文链表](Leetcode/0234.md)          |                    **模拟题**，别用容器试试。                    |
...
|              题目               | 难度  |                                        总结                                        |
| :-----------------------------: | :---: | :--------------------------------------------------------------------------------: |
| [🎯344. 反转字符串](Leetcode/0344.md) |   1   |                  循环很好写，注意参数是在递归的过程中不断改变的。                  |
